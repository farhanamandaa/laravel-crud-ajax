<aside id="sidebar-wrapper">
    ...
    <li class="dropdown">
		<a href="{{route('borrow')}}" class="nav-link"><i class="fa fa-arrow-right"></i><span>Peminjaman</span></a>
		<a href="{{route('return')}}" class="nav-link"><i class="fa fa-redo"></i><span>Pengembalian</span></a>
    </li>
    <li class="menu-header">Master Data</li>
    <li class="dropdown">
        <a href="#" class="nav-link has-dropdown"><i class="fa fa-file"></i><span>Master Data</span></a>
        <ul class="dropdown-menu">
            <li class=active><a class="nav-link" href="{{route('category')}}">Master Kategori</a></li>
            <li><a class="nav-link" href="{{route('book')}}">Master Buku</a></li>
        </ul>
    </li>
