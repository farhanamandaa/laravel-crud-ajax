        ...
        <div class="modal-content">           
            <div class="modal-header">             
                ...
                <div class="modal-body"> 
                    <form action="/transaction" method="POST" id="form-add" autocomplete="off">          
                    <div class="form-group">
                        @csrf
                        <label for="name">Nama Peminjam</label>
                        <input type="text" class="form-control" name="borrower_name" placeholder="Masukkan nama kategori.">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="quantity" placeholder="Masukkan nama kategori.">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
...
<script>
    var t =  $("#table-peminjaman").DataTable({  //inisiasi datatable
        ...
        ajax : {
            url : `{{route('ajax.borrows')}}`, //link yg digunakan sebagai sumber data
            cache : true,
        }, 
        columns: [
            {data: 'id'},
